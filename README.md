...
Language to Bash Commands Translation"** paper. **Tellina-Tool** was used for pre-processing and post-processing, and **Hugging Face** was used for tokenizer and dataset. More details are on my [blog](https://em-1001.github.io/natural%20language%20processing/ServalShell/).
